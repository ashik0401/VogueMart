      ...
      <div className='flex justify-center items-center min-h-screen px-4 sm:px-6  '>
            <div className='md:w-[50%] flex justify-center'>
                <form  className='md:space-y-4 p-5 rounded-xl md:w-96 shadow-md userForm border dark:border-gray-500 border-gray-200'>
                    <h2 className='font-semibold md:text-2xl text-lg text-center text-secondary dark:text-white'>Log in </h2>
                    ...
                    <p className='text-center mt-4'>
                        ...
                        href='/register'
                        >
                            <span className='ml-1  hover:underline text-blue-500'>Register</span>
                        </Link>
                    </p>
                </form>
            </div>
